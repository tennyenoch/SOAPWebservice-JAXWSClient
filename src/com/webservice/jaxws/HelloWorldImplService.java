 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://jaxws.webservice.com/", wsdlLocation = "http://localhost:8080/WS/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://jaxws.webservice.com/", "HelloWorldImplService");
    ...
    public HelloWorldInterface getHelloWorldImplPort() {
        return super.getPort(new QName("http://jaxws.webservice.com/", "HelloWorldImplPort"), HelloWorldInterface.class);
    }
     ...
     */
    @WebEndpoint(name = "HelloWorldImplPort")
    public HelloWorldInterface getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jaxws.webservice.com/", "HelloWorldImplPort"), HelloWorldInterface.class, features);
    }
